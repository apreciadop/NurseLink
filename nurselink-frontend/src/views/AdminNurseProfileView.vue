...
<template>
  <section class="admin-nurse-profile">
    <header class="nurse-profile-top">
      <router-link to="/admin/nurses" class="nurse-profile-back"><- Back to Nurses</router-link>
    </header>

    <p v-if="loading" class="nurse-profile-message">Loading nurse...</p>

    <p v-else-if="errorMessage" class="nurse-profile-message nurse-profile-message-error">{{ errorMessage }}</p>
            ...
            <table class="nurse-profile-patients-table">
              ...
              <tbody>
                <tr v-if="!filteredAssignedPatients.length">
                  <td colspan="5" class="nurse-profile-patients-empty">No assigned patients.</td>
                </tr>

                <tr v-for="patient in filteredAssignedPatients" :key="patient.patientId">
