...
<template>
  <section class="nurse">
      ...
      <nav class="nurse-sidebarnav" aria-label="Nurse menu">
        <ul class="nurse-sidebarmenu">
          <li class="nurse-sidebaritem">
            <router-link to="/nurse/dashboard" class="nurse-sidebarlink" :class="{ 'nurse-sidebarlink-active': isDashboardSection }" @click="closeSidebar">
              <img src="/icons/dashboardBlack.png" class="nurse-sidebaricon nurse-sidebaricon-default" alt=""/>
              <img src="/icons/dashboardBlue.png" class="nurse-sidebaricon nurse-sidebaricon-active" alt=""/>
              <span>Dashboard</span>
            </router-link>
          </li>

          <li class="nurse-sidebaritem">
            <router-link to="/nurse/messages" class="nurse-sidebarlink" :class="{ 'nurse-sidebarlink-active': isMessagesSection }" @click="closeSidebar">
              <img src="/icons/messagesBlack.png" class="nurse-sidebaricon nurse-sidebaricon-default" alt=""/>
              <img src="/icons/messagesBlue.png" class="nurse-sidebaricon nurse-sidebaricon-active" alt=""/>
              <span>Messages</span>
            </router-link>
          </li>
        </ul>
    ...
    <button v-if="isSidebarOpen" type="button" class="nurse-overlay" aria-label="Close menu" @click="closeSidebar"></button>
