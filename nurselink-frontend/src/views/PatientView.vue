        ...
        <ul class="patient-sidebarmenu">
          <li class="patient-sidebaritem">
            <router-link
              ...
              class="patient-sidebarlink"
              :class="{ 'patient-sidebarlink-active': isDashboardSection }"
              @click="closeSidebar"
            >
              <img
                src="/icons/dashboardBlack.png"
                class="patient-sidebaricon patient-sidebaricon-default"
                alt=""
              />
              <img
                src="/icons/dashboardBlue.png"
                class="patient-sidebaricon patient-sidebaricon-active"
                alt=""
              />
              <span>Dashboard</span>
            </router-link>
    ...
    <section class="patient-main">
      <header class="patient-topbar">
        <div class="patient-topbarheading">
          <button
            type="button"
            class="patient-topbarmenu-button"
            @click="toggleSidebar"
          >
            Menu
          </button>
          ...
          <span v-if="patientName" class="patient-topbarname">
            {{ patientName }}
          </span>
        </div>
