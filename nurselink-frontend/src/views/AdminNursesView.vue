...
<template>
  <section class="admin-nurses">
    ...
    <p
      ...
      class="admin-nursesmessage admin-nursesmessage-error"
    >
      {{ errorMessage }}
    </p>
    ...
    <article v-else class="nurses-panel">
      <header class="nurses-paneltoolbar">
        <div class="nurses-panelsearch-wrapper">
          <input
            v-model="searchTerm"
            type="text"
            class="nurses-panelsearch-input"
        ...
        <button
          type="button"
          class="nurses-paneladd-button"
          @click="openCreateNurseModal"
        >
          + Add Nurse
        </button>
      </header>
          ...
          <table class="nurses-table">
            ...
            <tbody>
              <tr v-if="!paginatedNurses.length">
                <td colspan="7" class="nurses-tableempty">
                  No nurses available.
                </td>
              </tr>
              ...
              <tr v-for="nurse in paginatedNurses" :key="nurse.nurseId">
                ...
                <td>
                  <span
                    :class="[
                      'nurses-statusbadge',
                      nurse.active ? 'nurses-statusbadge-active' : 'nurses-statusbadge-inactive'
                    ]"
                  >
                ...
                <td>
                  <router-link
                    :to="`/admin/nurses/${nurse.nurseId}`"
                    class="nurses-action-button nurses-action-button-icon"
                    :aria-label="`Edit nurse ${nurse.name} ${nurse.surname}`"
                    title="Edit nurse"
                  >
                    <img
                      src="/icons/edit.png"
                      alt=""
                      class="nurses-action-icon-image"
                    />
                  </router-link>
                </td>
              </tr>
      ...
      <footer class="nurses-panelpagination">
        <button
          type="button"
          class="nurses-panelpagination-button"
        ...
        <span class="nurses-panelpagination-text">
    ...
    <div v-if="isNurseModalOpen" class="nurses-modal-overlay">
      <div class="nurses-modal" @click.stop>
        <header class="nurses-modalheader">
          ...
          <button
            type="button"
            class="nurses-modalclose"
            aria-label="Close nurse modal"
        ...
        <section class="nurses-modalbody">
              ...
              <div class="nurses-modalphoto-row">
                <div class="nurses-modalphoto-preview">
                  <img
                    ...
                    :src="photoPreview"
                    alt="Nurse preview"
                    class="nurses-modalphoto-image"
                  />
                  <div v-else class="nurses-modalphoto-placeholder">
                    No image selected
                  </div>
                </div>
          ...
          <p v-if="nurseFormErrorMessage" class="nurses-modalerror">
        ...
        <footer class="nurses-modalfooter">
          <button
            type="button"
            class="nurses-modalbutton nurses-modalbutton-secondary"
            @click="closeNurseModal"
          >
            Cancel
          </button>
          ...
          <button
            type="button"
            class="nurses-modalbutton nurses-modalbutton-primary"
            :disabled="nurseFormLoading"
            @click="submitCreateNurse"
          >
            {{ nurseFormLoading ? 'Creating...' : 'Create' }}
          </button>
        </footer>
      </div>
    </div>
