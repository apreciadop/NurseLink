...
<template>
  <section class="nurse-dashboard">
    <p v-if="loading" class="nurse-dashboard-message">
      Loading assigned patients...
    </p>

    <p
      v-else-if="errorMessage"
      class="nurse-dashboard-message nurse-dashboard-message-error"
    >
      {{ errorMessage }}
    </p>
    ...
    <section v-else class="nurse-dashboard-main">
      <section class="nurse-dashboard-tablecard">
        <header class="nurse-dashboard-tablehead">
          <div class="nurse-dashboard-search">
            <input
              v-model="searchTerm"
              type="text"
              class="nurse-dashboard-search-input"
            ...
            <table class="nurse-dashboard-table">
              ...
              <tbody>
                <tr v-if="!paginatedPatients.length">
                  <td colspan="9" class="nurse-dashboard-empty">
                ...
                >
                  ...
                  <td class="nurse-dashboard-col-center">
                    <span
                      :class="[
                        'nurse-dashboard-activebadge',
                        patient.active
                          ? 'nurse-dashboard-activebadge-active'
                          : 'nurse-dashboard-activebadge-inactive'
                      ]"
                    >
                  ...
                  <td class="nurse-dashboard-col-center">
                    <span
                      :class="[
                        'nurse-dashboard-statusbadge',
                        patient.statusLabel === 'Stable'
                          ? 'nurse-dashboard-statusbadge-stable'
                          : patient.statusLabel === 'Warning'
                            ? 'nurse-dashboard-statusbadge-warning'
                            : 'nurse-dashboard-statusbadge-alert'
                      ]"
                    >
                      {{ patient.statusLabel }}
                    </span>
        ...
        <footer class="nurse-dashboard-pagination">
          <button
            type="button"
            class="nurse-dashboard-pagination-button"
          ...
          <span class="nurse-dashboard-pagination-text">
      ...
      <section class="nurse-dashboard-tablecard">
        <header class="nurse-dashboard-reporthead">
          <h2 class="nurse-dashboard-reporttitle">
            ...
            <span
              ...
              class="nurse-dashboard-reportpatient"
            >
        ...
        <section class="nurse-dashboard-tablebody">
          <div
            v-if="!selectedPatient"
            class="nurse-dashboard-empty nurse-dashboard-empty-panel"
          >
            Select a patient to view symptom reports.
          </div>
            ...
            <table class="nurse-dashboard-table nurse-dashboard-reports-table">
              ...
              <tbody>
                <tr v-if="!paginatedReports.length">
                  <td colspan="7" class="nurse-dashboard-empty">
                ...
                >
                  ...
                  <td class="nurse-dashboard-col-center">
                    <span
                      :class="[
                        'nurse-dashboard-alertbadge',
                        report.alertCount === 0
                          ? 'nurse-dashboard-alertbadge-stable'
                          : report.alertCount <= 2
                            ? 'nurse-dashboard-alertbadge-warning'
                            : 'nurse-dashboard-alertbadge-alert'
                      ]"
                    >
                      {{ report.alertCount }}
                    </span>
        ...
        <footer
          v-if="selectedPatient"
          class="nurse-dashboard-pagination"
        >
          <button
            type="button"
            class="nurse-dashboard-pagination-button"
